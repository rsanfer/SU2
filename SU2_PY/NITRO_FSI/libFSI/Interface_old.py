...
class Interface:
    ...
    def connect(self, FSI_config, FluidSolver, SolidSolver):
        ...
        # added for NITRO
        print("Routine: connect == DEBUG NITRO")
    ...
    def SteadyFSI(self, FSI_config, FluidSolver, SolidSolver, MLSSolver):
        ...
        if myid in self.solidSolverProcessors:
            SolidSolver.EvaluateIntefaceFluidDisplacements(FSIconfig, MLSSolver) # Flutter_mode_fluid_x/y/z are stored (root) once and for all
        ...
        if myid in self.solidSolverProcessors:
                SolidSolver.updateSolution()  # nit needed (Check)
