...
def main():
   ...
   string1 = 'mpirun -np ' +  str(options.partitions) + ' run_fsi_dynresp.py -f ' + filename_steady + ' -d ' + filename_dynresp + ' --parallel ... | tee ' + FSI_config['OUTPUT_DIRECTORY']  + '/' + options.echo   # ' ../fsi_computation_imposed.py -f '
   temp.write(string1 + '\n')
